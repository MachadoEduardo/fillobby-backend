...
import votingRoundsRoutes from "./src/modules/voting-rounds/voting-rounds.routes.js";
...
app.get("/", (req, res) =>
  res.status(200).json({ success: true, data: { message: "API Fillobby em funcionamento!" } }),
);
...
app.use("/api/v1/groups/:groupId/voting-rounds", votingRoundsRoutes);
