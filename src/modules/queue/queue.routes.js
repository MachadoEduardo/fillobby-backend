...
router.patch('/:itemId/participants', validate(adjustParticipantsSchema), controller.adjustParticipants);
...
router.patch('/:itemId/self-enrollment', validate(selfEnrollmentSchema), controller.setSelfEnrollment);
